...
type Reward struct {
	...
	RewardType  RewardType `protobuf:"varint,4,opt,name=reward_type,json=rewardType,proto3,enum=yellowstone_pb.solana.storage.ConfirmedBlock.RewardType" json:"reward_type,omitempty"`
